...
import java.awt.*;
	...
	public class VentanaPrincipal {
		...
		public VentanaPrincipal(String nombreUsuario) {
			...
			String[] rangosPrecio = { "Precio", "0-15", "15-30", "30-50", "50-100", "100-200", "200-500",
		...
		public void agregarAlCarrito(Ropa ropa) {
		    if (ropa.getCantidad() > 0) { // Verifica si hay stock disponible
		        ...
		        JOptionPane.showMessageDialog(ventana, ropa.getNombre() + " ha sido añadido al carrito."); // Mensaje de confirmación
		    } else {
		        JOptionPane.showMessageDialog(ventana, "No hay stock disponible para " + ropa.getNombre() + "."); // Mensaje de error
		    }
		}
		...
		private void cargarArticulos(List<Ropa> lista) {
		    ...
		    for (Ropa ropa : lista) {
		        ...
		        articuloPanel.add(Box.createHorizontalGlue()); // Añadir un espacio flexible para empujar el botón a la derecha
